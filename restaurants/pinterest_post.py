...
# write your code below
    def publish_photo_msg(self, message, image_url):
        headers={'access_token':str(self.page_access_token), 'board':self.board_id,'image_url':image_url,'note':message}
        requests.post('https://api.pinterest.com/v1/pins/',params=headers)
        return 
...
if __name__ == '__main__':
    ...
    pint.publish_photo_msg(message, image_url)
