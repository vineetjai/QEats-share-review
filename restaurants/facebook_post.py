...
class Facebook:
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        headers={'access_token':self.page_access_token,'page_id':self.page_id,'published':True,'url':image_url,'message':message} 
        requests.post("https://graph.facebook.com/me/photos",  data=headers)
        return
