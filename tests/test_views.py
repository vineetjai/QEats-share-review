...
class FacebookTestUtil:
    ...
    def get_user_feed(self):
        page_id = facebook.get_facebook_tokens()['FACEBOOK_PAGE_ID']
        page_access_token = facebook.get_facebook_tokens()['FACEBOOK_PAGE_ACCESS_TOKEN']
    ...
    def check_whether_message_is_published(self, message, image_path):
        ...
        if 'error' in user_feeds:
            print("\n\n",json.dumps(user_feeds, indent=4))
            return False
